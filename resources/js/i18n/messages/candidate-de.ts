export default {
    ...
    jobDetail: {
        ...
        benefits: 'Benefits & Unterstützung',
        chooseAnswer: 'Bitte auswählen',
        yes: 'Ja',
        no: 'Nein',
    },
    companies: {
    ...
    profile: {
        ...
        documents: {
            ...
            activeGrants: '{count} aktive Freigabe | {count} aktive Freigaben',
            grantExpires: 'Freigabe bis {date}',
            revoke: 'Widerrufen',
            revokeConfirm: 'Diese Dokumentfreigabe sofort widerrufen?',
            expiryDate: 'Ablaufdatum (optional)',
            chooseFile: 'Datei auswählen',
            removeFile: 'Datei entfernen',
            edit: 'Daten bearbeiten',
            replace: 'Neue Version',
            replaceSubmit: 'Version ersetzen',
            save: 'Dokumentdaten speichern',
            cancel: 'Abbrechen',
            deleteConfirm:
                '„{title}“ wirklich löschen? Aktive Freigaben werden sofort widerrufen.',
            types: {
                cv: 'Lebenslauf',
                passport: 'Reisepass',
