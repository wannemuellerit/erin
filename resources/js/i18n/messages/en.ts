export default {
    ...
    errors: {
        ...
        notFound: {
            ...
            returnPrefix: 'Click',
            returnLink: 'here',
            returnSuffix: ' to return to the home page.',
        },
    },
    roles: {
    ...
    nav: {
        ...
        settings: 'Settings',
        services: 'Services',
        partnerCases: 'Assigned cases',
        partners: 'Partner platform',
        groups: {
    ...
    services: {
        ...
        description:
            'Compare offers and stay in control of your data at all times.',
        newCase: 'Create service case',
        newCaseDescription:
            'An offer is optional; support coordinates manually when no partner is available.',
        service: 'Service',
        select: 'Please select',
        targetCountry: 'Target country',
        candidateId: 'Professional user ID',
        offering: 'Offer',
        manualFallback: 'Manual support',
        purpose: 'Specific purpose',
        translationDetails: 'Translation order',
        sourceLanguage: 'Source language (ISO)',
        targetLanguage: 'Target language (ISO)',
        documentType: 'Document type',
        pageCount: 'Page count',
        deadline: 'Deadline',
        optionalOffer: 'Optional quote in cents',
        openTasks: 'Response required',
        consent:
            'I explicitly consent to the purpose-bound and time-limited sharing of the selected data.',
        create: 'Create case',
        assignedCases: 'Assigned cases',
        myCases: 'My cases',
        empty: 'No cases yet',
        emptyDescription: 'Created and assigned service cases appear here.',
        transfer: 'Transfer to partner',
        withdraw: 'Withdraw consent',
        export: 'Export',
        statusSummary: 'Factual status note',
        update: 'Update status',
        offeringLabel: '{title} · {partner} · v{version}',
        statuses: {
            in_progress: 'In progress',
            waiting_for_candidate: 'Candidate response required',
        ...
        types: {
            language_course: 'Language & integration course',
    ...
    partnersAdmin: {
        ...
        description:
            'Partners, offers and country approvals are versioned and remain disabled until fully approved.',
        organizations: 'Partner organisations',
        organizationCounts:
            '{category} · {members} members · {offerings} offers',
        name: 'Name',
        createDraft: 'Create partner draft',
        countryMatrix: 'Country and legal matrix',
        country: 'Country',
        service: 'Service',
        status: 'Status',
        version: 'Version',
        ...
        legallyApproved: 'legally approved',
        newRuleVersion: 'New rule version',
        statuses: { disabled: 'Disabled', pilot: 'Pilot', enabled: 'Enabled' },
    },
    shell: {
        area: 'Area',
        ...
        searchEmpty: 'No permitted results found.',
        searchGroups: {
    ...
    settings: {
        ...
        notifications: {
            ...
            phoneTitle: 'SMS and WhatsApp',
            phoneDescription:
                'Verify a phone number and allow selected time-sensitive notices per channel. Messages stay short and contain no sensitive details.',
            phoneUnavailable:
                'SMS and WhatsApp are globally disabled until provider, country and privacy approvals are complete.',
            phonePlaceholder: '+491701234567',
            quietStart: 'Quiet hours start',
            quietEnd: 'Quiet hours end',
            phoneConsent:
                'I explicitly consent to receiving time-sensitive Faden notices via {channel}. I can revoke at any time or send STOP.',
            ...
            revoke: 'Revoke consent immediately',
            pushMissing:
            ...
            events: {
                ...
                document: {
                    title: 'Documents',
                    description: 'Review decisions for submitted documents.',
                },
                visa: {
                    title: 'Visa process',
                    description:
                        'Status changes and deadlines in the visa process.',
                },
                referral: {
                    title: 'Referrals',
                    description:
                        'Status and payout readiness of your referrals.',
                },
                reminder: {
                    title: 'Reminders',
                    description:
                ...
                billing: {
                    title: 'Billing',
                    description:
                        'Payment warnings and important subscription notices.',
                },
                boost: {
                    title: 'Job boosts',
                    description:
                        'Notices when job boosts become available again.',
                },
                company: {
                    title: 'Company team',
                    description: 'Accepted invitations and team changes.',
                },
                system: {
                    title: 'System & other',
                    description:
