...
<template>
    <Head
        :title="
            candidate
                ? `Kandidatenprofil ${candidate.label ?? candidate.id}`
                : 'Kandidatenprofil'
        "
    />
    <div class="erin-page">
        ...
        >
            <ArrowLeft class="size-4" /> Zurück zu Fachkräfte
        </Link>
        ...
        >
            <div>
                ...
                <p class="mt-2 text-sm text-slate-500">
                    Das Profil wurde nicht gefunden oder ist nicht mehr
                    veröffentlicht.
                </p>
            </div>
        </div>
        ...
        <template v-else>
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        >
                            {{
                                candidate.summary ||
                                'Noch keine Kurzbeschreibung hinterlegt.'
                            }}
                        </p>
                    </div>
            ...
            <div class="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
                <div class="space-y-6">
                    <SectionCard title="Berufliche Übersicht">
                                    ...
                                    },
                                    {
                                        ...
                                        value:
                                            candidate.languages
                                                ?.map(
                                                    (language) =>
                                                        `${language.name_de ?? language.code} ${language.level ?? ''}`,
                                                )
                                                .join(', ') ||
                                            'Nicht angegeben',
                                    },
                    ...
                    <SectionCard title="Skills & Qualifikationen">
                        <div
                    ...
                    <SectionCard title="Berufserfahrung">
                        <div
                        ...
                        <p v-else class="text-sm text-slate-400">
                            Noch keine Berufserfahrung hinterlegt.
                        </p>
                    </SectionCard>

                    <SectionCard title="Ausbildung">
                        <div
                        ...
                        <p v-else class="text-sm text-slate-400">
                            Noch keine Ausbildung hinterlegt.
                        </p>
                    </SectionCard>
                </div>

                <aside class="space-y-6">
                    <SectionCard title="Warum dieses Match?">
                        ...
                        <p v-else class="text-sm text-slate-400">
                            Wählen Sie in der Suche eine Stelle aus, um den
                            Match Score zu berechnen.
                        </p>
                    </SectionCard>

                    <SectionCard title="Zum Gespräch einladen">
                    ...
                    <SectionCard title="Im Talent-Pool speichern">
